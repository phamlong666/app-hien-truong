...
GDRIVE_CLIENT_SECRET = {
  ...
  # Đã thay đổi cách biểu diễn chuỗi private_key thành dấu ba nháy """ để đảm bảo không bị lỗi định dạng
...
nBtwsDY6COBC6oZezVgeSm4yPWEIRf1/+RJUezZMkcJAr4fajll+tqlfSSKRTPqh3
nbyYkVZd9w07lPe3WsToSohg=
-----END PRIVATE KEY-----""",
